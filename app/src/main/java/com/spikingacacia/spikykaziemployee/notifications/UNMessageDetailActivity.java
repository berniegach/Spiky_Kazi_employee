 ...
 * in a {@link UNMessageListActivity}.
 */
public class UNMessageDetailActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.a_unmessage_detail);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == android.R.id.home)
        {
            ...
            //
            navigateUpTo(new Intent(this, UNMessageListActivity.class));
            return true;
        }
