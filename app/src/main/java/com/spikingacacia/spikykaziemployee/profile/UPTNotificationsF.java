...
public class UPTNotificationsF extends Fragment
{
    ...
    private String url_update= LoginActivity.base_url+"update_u_notifications.php";
    ...
    public UPTNotificationsF()
    {
        // Required empty public constructor
    }
    public static UPTNotificationsF newInstance(String param1, String param2)
    {
        UPTNotificationsF fragment = new UPTNotificationsF();
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view= inflater.inflate(R.layout.f_uptnotifications, container, false);
   ...
   /* @Override
    ...
    private void addLayouts()
    {
        ...
        String notifications=LoginActivity.userAccount.getNotifications();
    ...
    public class UpdateTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            try
            {
                ...
                if(success==1)
                {
                    LoginActivity.userAccount.setNotifications(notifications);
                   return true;
                }
                else
                {
