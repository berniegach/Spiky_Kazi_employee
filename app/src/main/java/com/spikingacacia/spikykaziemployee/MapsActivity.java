        ...
        ActivityCompat.OnRequestPermissionsResultCallback
{
        ...
        fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                try
                {
                    ...
                    USettingsActivity.settingsChanged = true;
                    USettingsActivity.tempUserAccount.setLocation(String.format("%f,%f,%s",latMyPos.latitude,latMyPos.longitude,addresses.get(0).getLocality()));
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        String pos=LoginActivity.userAccount.getLocation();
        ...
        else
        {
            ...
            myMarker=mMap.addMarker(new MarkerOptions()
                    .position(latMyPos)
                    .title(LoginActivity.userAccount.getUsername()).draggable(true)
