...
public class CreateAccountF extends Fragment {
    ...
    private String url_create_account_user= LoginActivity.base_url+"create_account_user.php";
    private String url_update_password = LoginActivity.base_url+"update_password_user_account.php";
     ...
     */
    private RegisterTaskUser mAuthTaskU = null;
        ...
        if (cancel)
        {
        ...
        else
            {
                ...
                else
                {
                    ...
                    String message="You are about to create an account as an employee";
                    new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Proceed", new DialogInterface.OnClickListener()
                            {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i)
                                {
                                    mAuthTaskU = new RegisterTaskUser(email, password);
     ...
     * the user.
     */
    public class RegisterTaskUser extends AsyncTask<Void, Void, Boolean>
    {
        private final String mEmail;
        private final String mPassword;
        private int success;

        RegisterTaskUser(String email, String password)
        {
            mEmail = email;
            mPassword = password;
        }
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            JSONObject jsonObject=jsonParser.makeHttpRequest(url_create_account_user,"POST",info);
